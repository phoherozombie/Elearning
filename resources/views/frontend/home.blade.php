        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="cardFeature">
                    ...
                    <h5 class="font-title--xs">250k Online Courses</h5>
                    <p>
                        Explore a vast library of over 250,000 online courses covering technology,
                        business, design, and more. Learn at your own pace with expert instructors
                        and up-to-date content tailored to your goals.
                    </p>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="cardFeature">
                    ...
                    <p>
                        Learn from industry experts and experienced educators who bring real-world
                        knowledge into every course. Our instructors are dedicated to guiding you
                        step by step.
                    </p>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="cardFeature">
                    ...
                    <p>
                        Get unlimited lifetime access to all your courses and learn at your own pace,
                    ...
                    <div class="learning-rules__wrapper">
                        <div class="learning-rules-item">
                            ...
                            <div class="item-text">
                                ...
                                <p>
                                    Create your personal learning space where you can set goals,
                                    track progress, and stay motivated throughout your journey.
                                </p>
                            </div>
                        </div>
                        <div class="learning-rules-item">
                            ...
                            <div class="item-text">
                                <h6>Find the Best Course with Smart Filters.</h6>
                                <p>
                                    Discover courses that truly match your interests and career goals
                                    using advanced search and filtering tools for a better experience.
                                </p>
                            </div>
                        </div>
                        <div class="learning-rules-item">
                            ...
                            <div class="item-text">
                                <h6>Become a Master in Your Field.</h6>
                                <p>
                                    Learn from expert instructors, practice with real-world projects,
                                    and build the skills you need to succeed and lead in your career.
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container overflow-hidden">
        <div class="row mb-40">
            <div class="col-lg-6 mx-auto text-center brands-area-two-heading">
                ...
                <p>
                    More than 30,000 schools and colleges worldwide trust our platform to enhance
                    teaching and learning. We provide modern tools, engaging resources, and
                    reliable support to help educators and students achieve success together.
                </p>
            ...
            <div class="col-lg-6">
                <div class="main-become-instructor-item me-12">
                    ...
                    <div class="main-text">
                        ...
                        <p>
                            Share your knowledge with thousands of learners around the world.
                            As an Eduguard instructor, you’ll have the tools to create engaging courses,
                            inspire students, and grow your personal brand while earning income.
                        </p>
            ...
            <div class="col-lg-6">
                <div class="main-become-instructor-item ms-12 mb-0">
                    ...
                    <div class="main-text">
                        ...
                        <p>
                            Empower your workforce with Eduguard. Our platform helps organizations
                            streamline training, boost team performance, and maintain consistent
                            learning across every department. With smart tools and seamless integration,
                            professional development becomes simple, scalable, and impactful for
            ...
            <div class="col-lg-8 mx-auto">
                <div class="newsletter-area">
                    ...
                    <p class="mt-2 mb-lg-4 mb-3">
                        Stay updated with the latest courses, learning tips, and exclusive offers.
                        Join our newsletter and never miss an update from Eduguard.
                    </p>
